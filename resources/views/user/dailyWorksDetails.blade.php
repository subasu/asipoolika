            ...
            <div class="x_content">
                <table style="direction:rtl;text-align: center" id="example"
                    ...
                    <tr>
                        ...
                        <th style="text-align: center" class="">عنوان درخواست</th>
                        <th style="text-align: center" class="">توضیحات</th>
                        <th style="text-align: center;" class="col-md-2">تعداد</th>
                        <th style="text-align: center;" class="col-md-2">واحد سنجش</th>
                        <th style="text-align: center;" class="col-md-2">نرخ</th>
                        <th style="text-align: center;" class="col-md-2">قیمت</th>
                    </tr>
                    </thead>
                    <tbody id="change">
                    @foreach($requestRecords as $requestRecord)
                        <tr class="unit">
                            ...
                            <td>
                                {{$requestRecord->unit_count}}
                            </td>
                            <td>
                                {{number_format($requestRecord->rate)}}
                            </td>
                            <td>
                                {{number_format($requestRecord->price)}}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
