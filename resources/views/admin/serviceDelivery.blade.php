                    ...
                    <div class="x_content">
                        <form id="" name="">
                            ...
                            <table class="table table-bordered" dir="rtl">
                                <tr>
                                    <th class="remove-border col-md-4 text-right"> فرم شماره 6</th>
                                    <th class="remove-border col-md-3 text-left">تاریخ
                                        &nbsp;<input id="name" name="name" class="col-md-5" required="required" type="text"></th>
                                </tr>
                                <tr>
                                   <th class="remove-border col-md-3 text-left"></th>
                                    <th class="remove-border col-md-4 text-left">شماره
                            ...
                            <h4 dir="rtl" class="text-justify">بدینوسیله گواهی می شود خدمات انجام شده به شرح زیر توسط
                                شرکت/
                                فروشگاه
