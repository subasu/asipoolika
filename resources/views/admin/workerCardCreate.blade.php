                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-right input_mask" enctype="multipart/form-data" id="dealForm" style="direction: rtl;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group pull-right">
                                <lable style="font-size: 18px;"><span style="color:red">*</span> نام : </lable>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                <lable style="font-size: 18px;"><span style="color:red">*</span> نام خانوادگی : </lable>
                                <input type="text" class="form-control" style="text-align:right;" id="family"
                                       name="family" placeholder="نام خانوادگی" min="1" max="5" >
                            </div>

                            <div class="">
                                <lable style="font-size: 16px;">توضیحات : حجم فایل کارت کارگری نباید بیش از 150 کیلو بایت باشد ، پسوند فایل کارت کارگری باید از نوع png باشد.</lable>
                                    <div class="input-group image-preview col-md-12" style="margin-top:10px;padding:0px 10px !important;">
