                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-right input_mask" id="dealForm" style="direction: rtl;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback pull-right">
                                <input type="text" class="form-control" style="text-align:right;" id="owner"
                                       name="owner" placeholder="نام">
                                <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <input type="text" class="form-control" style="text-align:right;" id="buyer"
                                       name="buyer" placeholder="نام خانوادگی">
                                <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                            </div>
                            {{--<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback pull-right">--}}
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback pull-right">
                                <input type="number" class="form-control" style="text-align:right;" id="priority"
                                       name="priority" placeholder="درجه اهمیت" min="1" max="5">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3 col-sm-offset-3 col-xs-offset-1">
                                ...
                                <button type="button" name="addDeal" id="addDeal"
