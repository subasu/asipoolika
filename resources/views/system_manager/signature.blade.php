    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-xs-12" style="font-size: 18px;">
                    <div class="x_content">
                            ...
                            @foreach($signatures as $signature)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="label label-danger">اجباری</span>
                                        @else
                                        <span class="label label-info">اختیاری</span>
                                    @endif
                                    </td>
                                    ...
                                    <td>
                                        <a href="http://s9.picofile.com/file/8306682392/blesing_cover_.jpg" target="_blank" type="button"
                                           class="btn btn-round btn-default" data-toggle="tooltip" title="نمایش ملک">
                                            <span class="fa fa-search"></span>
                                        </a>
                                        <a href="{{url('customer/editPropertyShow/')}}" type="button"
                                           class="btn btn-round btn-success" data-toggle="tooltip" title="ویرایش ملک">
